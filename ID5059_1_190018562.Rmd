...
The residuals indicate an ok model because max and min are similar magnitude and suggest symmetry. 
```{r}
library(rpart)
...
```{r}
vehiclesBag <- randomForest(price ~ ., data = vehicles, subset = trainInd, mtry = 4, ntree = 25)
