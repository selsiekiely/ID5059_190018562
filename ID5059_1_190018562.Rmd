...
#Group by drive type to replace with fill() NA cylinder values more accurately. This accounts 
...
#We remove odometer values greater than 300000 miles and less than 10 miles
```
